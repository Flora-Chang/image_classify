...
from load_data import train_generator, validation_generator
...
def resnet50_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    x_newfc = Dense(num_classes, activation='softmax', name='fc80')(x_newfc)
...
if __name__ == '__main__':
    ...
    # Auto_save  best model
    best_model_file = "../models/little_weights.h5"
    best_model = ModelCheckpoint(best_model_file, monitor='val_acc', verbose=1, save_best_only=True)

    model = resnet50_model(FLAGS.height, FLAGS.width, FLAGS.channel, FLAGS.num_classes)
    model.fit_generator(train_generator,
                        steps_per_epoch=FLAGS.train_samples / FLAGS.batch_size,
                        nb_epoch=FLAGS.epoch,
                        verbose=1,
                        validation_data=validation_generator,
                        validation_steps=FLAGS.val_samples / FLAGS.batch_size,
